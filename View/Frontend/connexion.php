...
<div class="col-md-12">
	<div class="row">
		<div id="connexion_page" class="col-md-12">
			<form id="form_connexion"  class="offset-5 col-md-2" action="">
				...
				<div class="form-group offset-2">
					...
					<input class="form_login" type="submit" name="connexion" value="Connexion" /></br>
