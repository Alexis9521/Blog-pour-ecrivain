				...
				<div class="container">
					<div class="row">
						<div id="title_home" class="text-white text-center">
							...
							<p>Sur ce blog pour écrivain vous pourrez trouver les articles les commentaires de la communauté et je l'éspère voir l'avancé de mon roman en direct. Bonne lecture à vous tous et partagez au max.</p>
				...
				<div class="container">
					<div class="row">
						<div class="text-center text-white">
							...
							<p>Mon roman sera découpé en plusieurs articles je vous invite donc à tous les consulter à poster un petit commentaire l'avis de la communauté m'importe beaucoup et m'aidera à avancer sur mon projet. Je suis sûr que cela va vous plaire et oui c'est quand même moi qui ai écrit tous ça. Sur ce bonne lecture.</p>
